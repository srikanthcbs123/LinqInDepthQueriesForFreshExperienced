...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<EmpChennai> EmpChennais { get; set; }

    public virtual DbSet<EmpHyd> EmpHyds { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-AAO14OC;Database=Northwind;Trusted_Connection=True;Encrypt=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EmpChennai>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Emp_Chennai");
        ...
        modelBuilder.Entity<EmpHyd>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Emp_Hyd");
        ...
        {
            entity.HasKey(e => e.EmpId).HasName("PK__Employee__AF2DBB99774746CA");
        ...
        {
            entity.HasKey(e => e.Sid).HasName("PK__student__DDDFDD36A56206BF");
